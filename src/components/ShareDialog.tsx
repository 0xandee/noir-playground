    ...
    <TooltipProvider>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          {!shareUrl ? (
            // Before sharing: Show title input and share options
            <>
              {/* Title Input */}
            ...
            // After sharing: Show only title display and share URL
            <>
              {/* Title Display */}
              <div className="space-y-2">
                <Label>Title</Label>
                <div className="px-3 py-2 bg-muted/50 border rounded text-sm">
                  {title}
                </div>
              </div>
